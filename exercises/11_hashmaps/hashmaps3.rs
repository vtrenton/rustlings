...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        // Official Solution
        // While more clean and less lines I dont find it objectively better
        // than my approach. Lession learned given struct T
        // T::default will initialize an empty struct.
        //
        //let team1 = scores
        //    .entry(team_1_name)
